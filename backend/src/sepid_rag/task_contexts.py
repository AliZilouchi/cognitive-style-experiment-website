...
TASK_CONTEXT_VERSION = "sepid-swts-task-context-v2-receptive-task1"
...
TASK_CONTEXTS = {
    "task_1": {
        ...
        "objective": "کاربر باید در پایان بداند هر گزینه چه ویژگی‌هایی دارد.",
        "core_scope": "گزینه‌های اقامت، موقعیت، ظرفیت، هزینه، امکانات، غذا، مقررات و رزرو",
