...
export const DEFAULT_MODEL_EVALUATION_SCENARIOS: ModelEvaluationScenario[] = [
  ...
  {
    id: "food-absence-boundary",
    title: "غذا و مرزِ ندارد/ثبت نشده",
    taskId: "free_chat",
    questions: [
      "چه غذاخوری‌هایی در جزیره وجود دارد؟",
      "آن‌ها را از نظر نوع غذا و فضای نشستن مقایسه کن.",
      "کدام‌یک غذای گیاهی یا وگان دارد؟",
      "آیا باغ‌مزه غذای دریایی سرو می‌کند؟",
      "آیا آشپزخانه باران گزینه وگان ثابت دارد؟",
      "برای فرد دارای حساسیت غذایی چه اطلاعات قطعی داریم و چه چیزی مشخص نیست؟",
    ],
  },
];
